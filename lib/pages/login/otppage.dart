  ...
  Future<void> verifyOtpAndSignIn(String otp) async {
    ...
    try {
      ...
      if (userCredential.user != null) {
        ...
        //   // Navigate to onboarding/verification page
        //   Get.offAll(() => Temppage());
        // } else if (adminData.status == AdminStatus.approved) {
        // Navigate to admin dashboard
        Get.offAll(() => TurfHomepage());
        // } else if (adminData.status == AdminStatus.rejected) {
        //   // Show rejection message
        //   Get.offAll(() => Temppage());
        // } else if (adminData.status == AdminStatus.suspended) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        surfaceTintColor: Colors.transparent,
        // title: Text(
        //   'Partner Admin OTP Verification',
        //   style: TextStyle(
        //     fontSize: size.safeWidth * 0.045,
        //     fontWeight: FontWeight.bold,
        //     color: whiteColor,
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    'You are logging in as a Ticpin Play Partner. Your account will be reviewed before approval.',
                                    style: TextStyle(
                                      fontSize: size.safeWidth * 0.032,
                                      color: Colors.white70,
                                      fontFamily: 'Regular',
