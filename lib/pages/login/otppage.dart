...
import 'package:ticpin/constants/size.dart';
import 'package:ticpin/pages/home/homepage.dart';
import 'package:ticpin/services/otptimer.dart';
...
class _OtppageState extends State<Otppage> with CodeAutoFill, WidgetsBindingObserver {
  String otpCode = '';
  bool isVerifying = false;
  String? errorMessage;
  final UserService _userService = UserService();
  ...
  Future<void> resendOtp() async {
    if (!_timerService.canResend) {
      Get.snackbar(
        '',
        '',
        messageText: Text(
          'Please wait $_remainingSeconds seconds before resending',
          textAlign: TextAlign.center,
          style: TextStyle(
            fontSize: size.safeWidth * 0.03,
            fontFamily: 'Regular',
                              ...
                              FittedBox(
                                ...
                                child: Padding(
                                  ...
                                  child: _remainingSeconds > 0
                                      ? Text(
                                          '  (request again in ${_remainingSeconds}s)',
                                          style: TextStyle(
                                            fontSize: size.safeWidth * 0.032,
                                            color: whiteColor,
                                            fontFamily: 'Regular',
