...
class BlockbusterMovie extends StatefulWidget {
  const BlockbusterMovie({super.key});

  @override
  State<BlockbusterMovie> createState() => _BlockbusterMovieState();
}

class _BlockbusterMovieState extends State<BlockbusterMovie>
